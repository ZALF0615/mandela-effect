...
{
    private void OnCollisionStay2D(Collision2D collision) { if (collision.gameObject.tag == "Player" && SaboPlayerMove.instance.isHoldSpace ) SaboGameManager.instance.FireAllBomb(); }
